...
function sys_fatal_20437(message_20443) {
	var F={procname:"sysFatal.sysFatal",prev:framePtr,filename:"../../../../.choosenim/toolchains/nim-0.19.6/lib/system.nim",line:0};
	framePtr = F;
		F.line = 2915;
		var e_20445 = null;
		F.line = 2916;
...
function raise_assert_20432(msg_20434) {
	var F={procname:"system.raiseAssert",prev:framePtr,filename:"../../../../.choosenim/toolchains/nim-0.19.6/lib/system.nim",line:0};
	framePtr = F;
		F.line = 3872;
...
function failed_assert_impl_20481(msg_20483) {
	var F={procname:"system.failedAssertImpl",prev:framePtr,filename:"../../../../.choosenim/toolchains/nim-0.19.6/lib/system.nim",line:0};
	framePtr = F;
		F.line = 3879;
			...
			L2: do {
				F.line = 3913;
					...
					if (!(i_135419 < l_135421)) break L3;
						...
						F.line = 3916;
						failed_assert_impl_20481(makeNimstrLit("/home/travis/.choosenim/toolchains/nim-0.19.6/lib/system.nim(3916, 11) `len(a) == L` seq modified while iterating over it"));
						}
